package kr.co.koo.taeteon.board.controller;
...
import kr.co.koo.taeyeon.board.service.BoardListService;
import kr.co.koo.taeyeon.board.service.BoardService;
...
public class BoardController extends HttpServlet {
	...
	private void doRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(uri.equals("/WebProject-1/board/Blist.taeyeon")) { // 게시판을 클릭했다면
		...
		} else if(uri.equals("/WebProject-1/board/BWriteView.taeyeon")) {
