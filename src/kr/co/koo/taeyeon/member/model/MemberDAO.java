package kr.co.koo.taeyeon.member.model;
...
public class MemberDAO {
	...
	public int userCheck(String id, String pw) {
		...
		String sql = "SELECT user_pw FROM taeyeon_member WHERE user_id=?";
	...
	public boolean confirmId(String id) {
		...
		String sql = "SELECT user_id FROM taeyeon_member WHERE user_id=?";
	...
	public boolean insertMember(MemberVO members) {
		...
		String sql = "INSERT INTO taeyeon_member (user_id, user_pw, user_name, user_email) VALUES (?,?,?,?)";
	...
	public MemberVO getMemberInfo(String id){
		...
		String sql = "SELECT * FROM taeyeon_member WHERE user_id=?";
