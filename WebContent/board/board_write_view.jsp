...
<body>
  ...
  <section class="BOARD_WRITE">
  	<div class="inner">
  		<div class="register_btn">게시글 등록</div>
  		<div class="text_body">
  			<form action="/WebProject-1/board/Bwrite.taeyeon" method="post">
  				<div class="form_group">
  					<label>작성자</label>
  					<input type="text" class="form_control" value="${user_name}(${user_id})" readonly>
  				</div>
  				
  				<div class="form_group">
  					<label>제목</label>
  					<input type="text" class="form_control" name="bTitle">
  				</div>
  				
  				<div class="form_group">
  					<label>내용</label>
  					<textarea class="form_control" rows="5" name="bContent"></textarea>
  				</div>
  				
  				<input type="submit" value="등록" class="submit_btn">
  				<a class="form_control_btn" href="/WebProject-1/board/Blist.taeyeon">취소</a>
  			</form>
  		</div>
  	</div>
  </section>
