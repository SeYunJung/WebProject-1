...
<body>
  ...
  <section class="signup">
    ...
    <div class="signup__card">
      <form action="/WebProject-1/user/check_signup.jsp" name="sign-up" method="post" id="signUpForm">
      	<input type="text" placeholder="이름" name="userName">
      	<input type="email" placeholder="이메일" name="userEmail">
        <input type="text" placeholder="아이디" name="userId">
        <input type="password" placeholder="패스워드" name="userPw"><br />
        <button type="submit" class="signup_btn" name="signup-btn">회원가입</button>
      </form>
    </div>
  </section>
