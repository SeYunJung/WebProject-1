  	      ...
  	      <li>
  	        <div class="Album">
  	          <div class="first-album">
  	            <a href="/WebProject-1/albums/MyVoice.jsp">
  	              <img src="/WebProject-1/static/images/My Voice.png" width="400" height="400">
  	            </a>
  	          </div>
  	          <div class="second-album">
  	            <a href="/WebProject-1/albums/Purpose.jsp">
  	              <img src="/WebProject-1/static/images/Purpose.png" width="400" height="400">
  	            </a>
  	          </div>
  	          <div class="third-album">
  	            <a href="/WebProject-1/albums/INVU.jsp">
  	              <img src="/WebProject-1/static/images/INVU.png" width="400" height="400">
  	            </a>
  	          </div>
  	        </div>
  	      </li>
  	      <li>
  	        <div class="EP">
  	          <div class="first-mini">
  	            <a href="/WebProject-1/albums/I.jsp">
  	              <img src="/WebProject-1/static/images/I.png" width="400" height="400">
  	            </a>
  	          </div>
  	          <div class="second-mini">
  	            <a href="/WebProject-1/albums/Why.jsp">
  	              <img src="/WebProject-1/static/images/Why.png" width="400" height="400">
  	            </a>
  	          </div>
  	          <div class="third-mini">
  	            <a href="/WebProject-1/albums/Something.jsp">
  	              <img src="/WebProject-1/static/images/Something New.png" width="400" height="400">
  	            </a>
  	          </div>
  	          <div class="fourth-mini">
  	            <a href="/WebProject-1/albums/WhatDo.jsp">
  	              <img src="/WebProject-1/static/images/What Do I Call You.png" width="400" height="400">
  	          	</a>
  	          </div>
  	        </div>
  	      </li>
  	      <li>
  	        <div class="Single">
  	          <div class="single-rain">
  	            <a href="/WebProject-1/albums/Rain.jsp">
			      <img src="/WebProject-1/static/images/Rain.png" width="400" height="400">
    	  	    </a>
    	  	  </div>
    	  	  <div class="single-eleven">
    	  	    <a href="/WebProject-1/albums/eleven.jsp">
			      <img src="/WebProject-1/static/images/11.png" width="400" height="400">
		      	</a>
		      </div>
		      <div class="single-fourseason">
		        <a href="/WebProject-1/albums/FourSeason.jsp">
			      <img src="/WebProject-1/static/images/Four Season.png" width="400" height="400">
		        </a>
		      </div> 
		      <div class="single-happy">
		        <a href="/WebProject-1/albums/Happy.jsp">
			      <img src="/WebProject-1/static/images/Happy.png" width="400" height="400">
		        </a>
		      </div>
		      <!-- <div class="single-weekend">
			    <img src="/WebProject-1/static/images/Weekend.png" width="400" height="400">
		      </div>
		      <div class="cant">
		        <img src="/WebProject-1/static/images/Can't Control Myself.png" width="400" height="400">
		      </div>
		       -->
  	        </div>
		  </li>
